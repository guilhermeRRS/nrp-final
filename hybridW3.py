...
if True:
    ...
    if nurse.s_data and nurse.s_model and nurse.s_solution:
        ...
        success, nurse = hybrid.run(objs[int(instance)-1], runRandom = False, noRelax = False, nurseBefore = True, numberOfNurses_fixDay = 8, numberOfNurses_fixNurse = 3, numberOfDays = 21)
