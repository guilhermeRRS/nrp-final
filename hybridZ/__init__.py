...
class Hybrid:
    ...
    from ._manager import startSeqs, startSingles, manager_singleDeep, manager_singleSearch, manager_seqShorterBetter, manager_seqShorterWorser, manager_seqHugeWorser, run_internal_shiftAll, run_internal_innerFix, run_internal_dayInnerFix, run_internal_balanced, run_internal_shiftFix
    ...
    def run(self, startObj):
        ...
        self.nurseModel.model.m.setParam("MIPGap", 10/100)
        self.nurseModel.model.m.setParam("MIPFocus", 1)
        
        self.run_internal_shiftFix(max(1, self.chronos.timeLeftForVND()), "workFree")   
        input("Work") 
        self.run_internal_shiftFix(max(1, self.chronos.timeLeftForVND()), "extremes")    
        input("Extremes")
        self.run_internal_shiftFix(max(1, self.chronos.timeLeft()), "all")
        ...
        m.setParam("TimeLimit", max(self.chronos.timeLeft(), 1000))
