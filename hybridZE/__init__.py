...
class Hybrid:
    ...
    def run(self, startObj, runRandom:bool = True, noRelax = False, nurseBefore = False, numberOfNurses_fixDay = 5, numberOfNurses_fixNurse = 2, numberOfDays = 12, overlapping_nurse_fixNurse = 1, overlapping_nurse_fixDay = 1, overlapping_day_fixDay = 7):
        ...
        while self.chronos.stillValidMIP() and keepFix:
            ...
            if True:
                ...
                if True:
                    for pos in range(0, self.nurseModel.I, min(overlapping_nurse_fixNurse, numberOfNurses_fixNurse)):
                    ...
                    for posI in range(0, self.nurseModel.I, min(overlapping_nurse_fixDay, numberOfNurses_fixDay)):
                        if not self.chronos.stillValid():
                            break
                        for posD in range(0,self.nurseModel.D, overlapping_day_fixDay):
                            if not self.chronos.stillValid():
                                break
