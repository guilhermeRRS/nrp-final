...
if True:
    ...
    if nurse.s_data and nurse.s_model and nurse.s_solution:
        ...
        success, nurse = hybrid.run(objs[int(instance)-1], runRandom = False, noRelax = False, nurseBefore = True, numberOfNurses_fixDay = 2*0.02, numberOfNurses_fixNurse = 0.02, numberOfDays = 0.07)
